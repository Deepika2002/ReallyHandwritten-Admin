...
const navigation = [
  ...
  { name: 'Users', href: '/users/users', icon: UserGroupIcon, current: false },
  { name: 'Send Cards', href: '/sendcards', icon: UserGroupIcon, current: false },
  { name: 'Sent Cards', href: '/sentcards', icon: ArrowDownTrayIcon, current: false },
